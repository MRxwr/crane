...
<div class="panel-heading">
	<div class="pull-left"><h6 class="panel-title txt-dark"><?php echo direction("List of Get In Touch","قائمة المراسلات الزوار") ?></h6></div>
...
<div class="table-responsive">
	<table class="table display responsive product-overview mb-30" id="myTable">
		...
		<tbody>
		<?php 
		if( $contacts = selectDB("get_in_touch","`status` = '0' AND `hidden` != '2' ORDER BY `id` DESC") ){
			for( $i = 0; $i < sizeof($contacts); $i++ ){
				...
				if ( $contacts[$i]["hidden"] == 1 ){
					...
					$icon = "fa fa-eye-slash txt-danger";
