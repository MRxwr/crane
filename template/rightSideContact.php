    ...
    <div class="row m-0">
        ...
        <div class="col-md-6 p-5">
            <div class="row">
                <div class="col-12">
                    <h1>Contact</h1>
                    <h5 style="font-weight:400">Lorem Ipsum is simply dummy text of the printing
                        and typesetting industry. Lorem Ipsum has been
                        the industry
                        's standard dummy text ever since the
