<div class="leftContent sides">
    <div class="row">
        <div class="col-12 pt-3 pb-3 text-center" style="font-size:50px;font-weight:600">Crane<span class="craneDot">.</span></div>
        <div class="col-3"></div>
        <div class="col-9">
            <ul>
            <li id="home"><a href="?v=Home" alt="Home"><?php echo direction("Home","الرئيسية") ?></a></li>
            <li id="how"><a href="?v=How" alt="How"><?php echo direction("How it works","كيف نعمل") ?></a></li>
            <li id="services"><a href="?v=Services" alt="Services"><?php echo direction("Services","خدامتنا") ?></a></li>
            <li id="contact"><a href="?v=Contact" alt="Contact"><?php echo direction("Contact","تواصل معنا") ?></a></li>
            <li id="privacy"><a href="?v=Policy" alt="Policy"><?php echo direction("Privacy & Policy","سياسة الخصوصية") ?></a></li>
            </ul>
        </div>
